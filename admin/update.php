<?php
	...
	$query = "update profiles SET fio= '" . $fio . "', birth= '" . $birth . "', kind_of_sport= '" . $kind_of_sport . "', faculty = '" . $faculty . "', level = '" . $level . "', achievements = '" . $achievements . "', phone = '" . $phone . "', email = '" . $email . "' where id =  " . $id;
